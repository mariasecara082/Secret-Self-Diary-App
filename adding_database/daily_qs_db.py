...
def update_slider_value(value):
    slider_value_label.configure(text=f"{float(value):.1f}")

#Creating slider
q3_slider = ctk.CTkSlider(frame_q3, from_=0, to=10, number_of_steps=20, width=600, command=update_slider_value)
q3_slider.set(5)
...
def q3_answers():
    ...
    try:
        ...
        homepage_path = "/Users/maria/Desktop/13DDT/13DDT-PROG-MariaSecara/Secret Self Diary App/adding_database/homepage_db.py"
        if user_id:
